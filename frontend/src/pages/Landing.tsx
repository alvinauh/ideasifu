...
export default function Landing() {
  ...
  function handleGenerate(e: React.FormEvent) {
    ...
    const brief: Brief = {
      ...
      tier,
      level: level.trim() || (tier === "university" ? "Undergraduate" : "High school"),
    ...
    <main className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-4xl px-4 pb-24 pt-14 text-center">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="mt-12 inline-flex items-center gap-1.5 text-sm text-muted underline-offset-4 transition-colors hover:text-foreground hover:underline"
        >
          Already have a draft? Audit it with ThesisSifu
